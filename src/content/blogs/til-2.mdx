...
<Aside
  ...
  text="To be honest, running checking the type of arr with typeof and seeing [object Object] return might have been the biggest clue to realize that it's an object."
/>

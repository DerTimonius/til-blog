...
<AnimateCodeBlock
  client:only="svelte"
  lang="ts"
  previous={`const arr = new ArrayBuffer(8);
console.log(arr);
// ArrayBuffer {
//   [Uint8Contents]: <00 00 00 00 00 00 00 00>,
//   byteLength: 8
// }`}
  next={`const arr8View = new Uint8Array(arr);
arr8View[1] = 12;
console.log(arr);
// ArrayBuffer {
...
<AnimateCodeBlock
  client:only="svelte"
  lang="ts"
  next={`const arr16View = new Uint16Array(arr);
arr16View[1] = 45;
console.log(arr);
// ArrayBuffer {
...
//   byteLength: 8
// }`}
  previous={`const arr8View = new Uint8Array(arr);
arr8View[1] = 12;
console.log(arr);
// ArrayBuffer {
//   [Uint8Contents]: <00 0c 00 00 00 00 00 00>,
